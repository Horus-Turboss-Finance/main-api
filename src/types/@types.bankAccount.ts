export enum BankAccountType {
  ...
  CASH = "cash",
  CAISSE = "caisse",
  COMPTE_ASSOCIATIF = "compte_associatif",
  COMPTE_GOUVERNEMENTAL = "compte_gouvernemental",
  ...
  TRAVEL_CARD_ACCOUNT = "travel_card_account",
